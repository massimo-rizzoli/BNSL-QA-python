...
def main():
  ...
  with open('datasets/WasteExp{}.txt'.format(size), 'w') as file:
            ...
            for filterEfficiency in range(2):
              ...
              for metalsInWaste in range(2):
                ...
                for dustEmission in range(2):
                  if burningRegimen == STABLE and wasteType == INDUSTRIAL and filterEfficiency == H:
                    if dustEmission == H:
                      deprob = 0; continue
                    elif dustEmission == L:
                      deprob = 1
                  elif burningRegimen == STABLE and wasteType == INDUSTRIAL and filterEfficiency == L:
                    if dustEmission == H:
                      deprob = 1
                    elif dustEmission == L:
                      deprob = 0; continue
                  elif burningRegimen == STABLE and wasteType == HOUSEHOLD and filterEfficiency == H:
                    if dustEmission == H:
                      deprob = 0; continue
                    elif dustEmission == L:
                      deprob = 1
                  elif burningRegimen == STABLE and wasteType == HOUSEHOLD and filterEfficiency == L:
                    if dustEmission == H:
                      deprob = 0.99
                    elif dustEmission == L:
                      deprob = 0.01
                  elif burningRegimen == UNSTABLE and wasteType == INDUSTRIAL and filterEfficiency == H:
                    if dustEmission == H:
                      deprob = 0.000024
                    elif dustEmission == L:
                      deprob = 0.999976
                  elif burningRegimen == UNSTABLE and wasteType == INDUSTRIAL and filterEfficiency == L:
                    if dustEmission == H:
                      deprob = 1
                    elif dustEmission == L:
                      deprob = 0; continue
                  elif burningRegimen == UNSTABLE and wasteType == HOUSEHOLD and filterEfficiency == H:
                    if dustEmission == H:
                      deprob = 0.003
                    elif dustEmission == L:
                      deprob = 0.997
                  elif burningRegimen == UNSTABLE and wasteType == HOUSEHOLD and filterEfficiency == L:
                    if dustEmission == H:
                      deprob = 1
                    elif dustEmission == L:
                      deprob = 0; continue
