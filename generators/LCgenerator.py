...
def main():
  ...
  with open('datasets/LC{}.txt'.format(size), 'w') as file:
    ...
    for i in range(examples):
      ...
      if cancer == T:
        ...
        xprob = 0.20
      xray = POS if random.uniform(0,1) <= xprob else NEG
      xrayCount[xray] += 1
      ...
      if cancer == T:
        ...
        dprob = 0.30
      dyspnoea = T if random.uniform(0,1) <= dprob else F
      dyspnoeaCount[dyspnoea] += 1
